...
function DashboardPage() {
    ...
    useEffect(() => {
        // Since main.jsx waits, 'tg' will exist here.
        tg.ready();
        tg.expand();

        // Check for initData right away.
        if (!tg.initData) {
            setError("Telegram authentication data (initData) is not available. This app must be run from a button inside Telegram.");
            setLoading(false);
            return;
        }
    ...
    // ... The rest of your handler functions (handleCreatePlanClick, etc.) remain unchanged ...
